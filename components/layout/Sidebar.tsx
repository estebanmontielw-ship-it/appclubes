...
import {
  ...
  DollarSign, BarChart3, Lock, X, Globe, Bot, Search, Zap, Camera, ClipboardList, Calculator, Palette, Shield, Activity,
} from "lucide-react"
    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Análisis de Manipulación", href: "/oficiales/admin/integridad", icon: Activity },
        ],
      },
      {
        label: "DATOS EN VIVO",
