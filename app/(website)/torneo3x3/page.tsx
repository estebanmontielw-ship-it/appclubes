    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-lg mx-auto px-4 py-5 space-y-4">
        ...
        <a
          ...
          className="flex items-center justify-center gap-2 py-3 rounded-2xl border border-gray-200 bg-white text-sm text-gray-600 hover:border-blue-300 hover:text-blue-600 transition-colors font-medium"
        >
          <span>🏀</span>
          Ver fixture y resultados en fiba3x3.com
