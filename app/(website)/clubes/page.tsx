...
const equipos: Equipo[] = [
  ...
  { nombre: "Cerro Porteño", federacion: "Metropolitano", ciudad: "Asunción", logo: "/logos/Cerro_Porteno.jpg" },
  { nombre: "Escuela Caaguaceña de Basquetbol", federacion: "Federación Caaguaceña", ciudad: "Caaguazú", logo: "/logos/Escuela_Caaguacena_de_Basquetbol.jpg" },
  { nombre: "Sajonia", federacion: "Metropolitano", ciudad: "Asunción", logo: "/logos/Sajonia.png" },
  { nombre: "Juventud", federacion: "Federación de Colonias Unidas", ciudad: "Hohenau", logo: "/logos/Juventud.jpg" },
  { nombre: "Sportivo Sanlorenzo", federacion: "Federación Sanlorenzana", ciudad: "San Lorenzo", logo: "/logos/Sportivo_Sanlorenzo.png" },
  { nombre: "Club Deportivo Central", federacion: "Metropolitano", ciudad: "Capiatá", logo: "/logos/Club_Deportivo_Central.jpg" },
  { nombre: "Club Atlético Pilarense", federacion: "Asociación Pilarense", ciudad: "Pilar", logo: "/logos/Club_Atletico_Pilarense.jpg" },
  { nombre: "Deportivo Yacaré", federacion: "Metropolitano", ciudad: "Asunción", logo: "/logos/Deportivo_Yacare.png" },
  { nombre: "Club Atlético Ciudad Nueva", federacion: "Metropolitano", ciudad: "Asunción", logo: "/logos/Club_Atletico_Ciudad_Nueva.png" },
  { nombre: "Club Deportivo Amambay", federacion: "Federación de Amambay", ciudad: "Pedro Juan Caballero", logo: "/logos/Club_Deportivo_Amambay.jpg" },
  { nombre: "Guaireña Basquet Club", federacion: "Federación Guaireña", ciudad: "Villarrica", logo: "/logos/Guairena_Basquet_Club.jpg" },
  { nombre: "Club Cerro Porteño del Barrio Azucena", federacion: "Federación Ovetense", ciudad: "Coronel Oviedo", logo: "/logos/Club_Cerro_Porteno_del_Barrio_Azucena.jpg" },
  { nombre: "Club Deportivo Internacional", federacion: "Metropolitano", ciudad: "Asunción", logo: "/logos/Club_Deportivo_Internacional.png" },
  { nombre: "Club Pettirossi", federacion: "Federación Encarnacena", ciudad: "Encarnación", logo: "/logos/Club_Pettirossi.jpg" },
  { nombre: "Club Sportivo Luqueño Basquetbol", federacion: "Metropolitano", ciudad: "Luque", logo: "/logos/Club_Sportivo_Luqueno_Basquetbol.jpg" },
  { nombre: "Gorillas Basquet", federacion: "Federación de Hernandarias", ciudad: "Ciudad del Este", logo: "/logos/Gorillas_Basquet.jpg" },
  { nombre: "Club Atlético Paranaense", federacion: "Federación Encarnacena", ciudad: "Encarnación", logo: "/logos/Club_Atletico_Paranaense.png" },
  { nombre: "Colonias Unidas Basket Club", federacion: "Federación de Colonias Unidas", ciudad: "Obligado", logo: "/logos/Colonias_Unidas_Basket_Club.jpg" },
  { nombre: "Club Deportivo Campo Alto", federacion: "Metropolitano", ciudad: "Asunción", logo: "/logos/Club_Deportivo_Campo_Alto.png" },
  { nombre: "Sol de América", federacion: "Metropolitano", ciudad: "Asunción", logo: "/logos/Sol_de_America.png" },
